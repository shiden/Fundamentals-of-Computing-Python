#Write a Python function point_distance that takes as the parameters x0, y0,
#x1 and y1, and returns the distance between the points (x0,y0) and (x1,y1).
...
#saved as: http://www.codeskulptor.org/#user44_St591i5HS1_0.py
