...
#(s−a)(s−b)(s−c)−−−−−−−−−−−−−−−−√ where a, b and c are 
#he lengths of the sides of the triangle and s=12(a+b+c) 
#s thesemi-perimeterof the triangle. Given the variables
#0, y0, x1,y1, x2, and y2, write a Python program that 
#omputes a variable area whose value is the area of the 
#riangle with vertices (x0,y0), (x1,y1) and (x2,y2). 
