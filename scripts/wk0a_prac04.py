...
#Given a template that pre-defines the variables width 
#and height that are the lengths of the sides of a 
#rectangle, write an assignment statement that defines a 
#variable area whose value is the area of the rectangle 
#in square inches. 
###################################################
# Tests
